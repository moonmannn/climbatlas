...
export const metadataRoutesByDestination: Record<string, RouteHighlight[]> = {
  ...
  "fontainebleau-france": [
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: La Baleine",
          url: "https://bleau.info/canon/462.html",
          type: "route-database" as const,
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: La Mouche",
          url: "https://bleau.info/beauvais/88.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Hip Hop",
          url: "https://bleau.info/cailles/1154.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Graviton",
          url: "https://bleau.info/sabots/782.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Magic Bus",
          url: "https://bleau.info/y/686.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Le Pendu",
          url: "https://bleau.info/pendu/938.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Le Bilboquet",
          url: "https://bleau.info/envers/5116.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: El Poussah",
          url: "https://bleau.info/isatis/551.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Le Sphinx",
          url: "https://bleau.info/canon/18892.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: La Balance",
          url: "https://bleau.info/cuvier/274.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Bleau.info: Le Plafond",
          url: "https://bleau.info/jouanne/389.html",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
  ...
  "kalymnos-greece": [
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Daniboy",
          url: "https://www.mountainproject.com/route/107801184/daniboy",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "spartacus-sector-kalymnos",
      name: "Spartacus sector",
      grade: "6a-8a",
      type: "sport" as const,
      length: "sector",
      sector: "Spartacus",
    ...
    {
      id: "grande-grotta-kalymnos",
      name: "Grande Grotta sector",
      grade: "6a-8a",
      type: "sport" as const,
      length: "sector",
      sector: "Grande Grotta",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Aroma",
          url: "https://www.mountainproject.com/route/126081245/aroma",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Bye Bye Doc",
          url: "https://www.mountainproject.com/route/107623918/bye-bye-doc",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Styx",
          url: "https://www.mountainproject.com/route/108421050/styx",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Priapos",
          url: "https://www.mountainproject.com/route/107179233/priapos",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Wings for Life",
          url: "https://www.mountainproject.com/route/107867694/wings-for-life",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: DNA",
          url: "https://www.mountainproject.com/route/106804759/dna",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Fun de Chichunne",
          url: "https://www.mountainproject.com/route/107804615/fun-de-chichunne",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Kerveros",
          url: "https://www.mountainproject.com/route/106924634/kerveros",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Aegialis",
          url: "https://www.mountainproject.com/route/106804781/aegialis",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
  ...
  "red-river-gorge-usa": [
    {
      id: "stunning-the-hog-red-river-gorge",
      name: "Stunning the Hog",
      grade: "5.12d",
      type: "sport" as const,
      length: "single pitch",
      sector: "Muir Valley",
      ...
      externalResources: [
        {
          title: "Mountain Project: Stunning the Hog",
          url: "https://www.mountainproject.com/route/106146849/stunning-the-hog",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "table-of-colors-red-river-gorge",
      name: "Table of Colors",
      grade: "5.13a",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Table of Colors",
          url: "https://www.mountainproject.com/route/106304964/table-of-colors",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "mercy-the-huff-red-river-gorge",
      name: "The Mercy the Huff",
      grade: "5.12b",
      type: "sport" as const,
      length: "single pitch",
      sector: "Red River Gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Mercy, the Huff",
          url: "https://www.mountainproject.com/route/106045269/mercy-the-huff",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Ale-8-One",
          url: "https://www.mountainproject.com/route/106445478/ale-8-one",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Nagypapa",
          url: "https://www.mountainproject.com/route/106053937/nagypapa",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Ro Shampo",
          url: "https://www.mountainproject.com/route/105860759/ro-shampo",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "chocolate-factory-red-river-gorge",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Oompa",
          url: "https://www.mountainproject.com/route/106782060/oompa",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "snozzberries-red-river-gorge",
      name: "Snozzberries",
      grade: "5.12a",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Snozzberries",
          url: "https://www.mountainproject.com/route/108411358/snozzberries",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "drive-by-crag-red-river-gorge",
      name: "Drive-By Crag",
      grade: "5.10-5.13",
      type: "sport" as const,
      length: "wall sector",
    ...
    {
      id: "breakfast-burrito-red-river-gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Breakfast Burrito",
          url: "https://www.mountainproject.com/route/106081922/breakfast-burrito",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "boltergeist-red-river-gorge",
      name: "Boltergeist",
      grade: "5.11b",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Boltergeist",
          url: "https://www.mountainproject.com/route/106580228/boltergeist",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "air-ride-equipped-red-river-gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Air Ride Equipped",
          url: "https://www.mountainproject.com/route/106586504/air-ride-equipped",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "tissue-tiger-red-river-gorge",
      name: "Tissue Tiger",
      grade: "5.12b",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Tissue Tiger",
          url: "https://www.mountainproject.com/route/105870261/tissue-tiger",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "chainsaw-massacre-red-river-gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Chainsaw Massacre",
          url: "https://www.mountainproject.com/route/106153682/chainsaw-massacre",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "paradise-lost-red-river-gorge",
      name: "Paradise Lost",
      grade: "5.13a",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Paradise Lost",
          url: "https://www.mountainproject.com/route/106575827/paradise-lost",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "bronaugh-wall-red-river-gorge",
      name: "Bronaugh Wall",
      grade: "5.10-5.13",
      type: "sport" as const,
      length: "wall sector",
    ...
    {
      id: "solar-collector-red-river-gorge",
    ...
    {
      id: "amarillo-sunset-red-river-gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Amarillo Sunset",
          url: "https://www.mountainproject.com/route/106286394/amarillo-sunset",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Banshee",
          url: "https://www.mountainproject.com/route/106333612/banshee",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "johnny-b-good-red-river-gorge",
      name: "Johnny B. Good",
      grade: "5.11a",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Johnny B. Good",
          url: "https://www.mountainproject.com/route/106154626/johnny-b-good",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "cell-block-six-red-river-gorge",
      name: "Cell Block Six",
      grade: "5.12c",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Cell Block Six",
          url: "https://www.mountainproject.com/route/106586323/cell-block-six",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Convicted",
          url: "https://www.mountainproject.com/route/106598931/convicted",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Hippocrite",
          url: "https://www.mountainproject.com/route/106126244/hippocrite",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Rat Stew",
          url: "https://www.mountainproject.com/route/106061906/rat-stew",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "mona-lisa-overdrive-red-river-gorge",
      ...
      externalResources: [
        {
          title: "Mountain Project: Mona Lisa Overdrive",
          url: "https://www.mountainproject.com/route/106925375/mona-lisa-overdrive",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "team-wilson-red-river-gorge",
      name: "Team Wilson",
      grade: "5.11c",
      type: "sport" as const,
      length: "single pitch",
      ...
      externalResources: [
        {
          title: "Mountain Project: Team Wilson",
          url: "https://www.mountainproject.com/route/106916504/team-wilson",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
  ...
  "squamish-canada": [
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Crime of the Century",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Merci Me",
          url: "https://www.mountainproject.com/route/106527466/merci-me",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Minor Threat",
          url: "https://www.mountainproject.com/route/111998633/minor-threat",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Angel's Crest",
          url: "https://www.mountainproject.com/route/105847203/angels-crest",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "ultimate-everything-squamish",
      ...
      externalResources: [
        {
          title: "Mountain Project: The Ultimate Everything",
          url: "https://www.mountainproject.com/route/106480430/the-ultimate-everything",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Flying Circus",
          url: "https://www.mountainproject.com/route/105845816/flying-circus",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Neat and Cool",
          url: "https://www.mountainproject.com/route/105910806/neat-and-cool",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Mosquito",
          url: "https://www.mountainproject.com/route/105842817/mosquito",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Klahanie Crack",
          url: "https://www.mountainproject.com/route/105947052/klahanie-crack",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Quarryman",
          url: "https://www.mountainproject.com/route/105857742/quarryman",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Penny Lane",
          url: "https://www.mountainproject.com/route/105842825/penny-lane",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Bullethead East",
          url: "https://www.mountainproject.com/route/107237875/bullethead-east",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Skywalker",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Star Chek",
          url: "https://www.mountainproject.com/route/107104796/star-chek",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Apron Strings",
          url: "https://www.mountainproject.com/route/105886110/apron-strings",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: St. Vitus' Dance",
          url: "https://www.mountainproject.com/route/105843781/st-vitus-dance",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Diedre",
          url: "https://www.mountainproject.com/route/105857666/diedre",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Rambles",
          url: "https://www.mountainproject.com/route/107577227/rambles",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Boomstick Crack",
          url: "https://www.mountainproject.com/route/106188277/boomstick-crack",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: The Zip",
          url: "https://www.mountainproject.com/route/105941644/the-zip",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Laughing Crack",
          url: "https://www.mountainproject.com/route/105959460/laughing-crack",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Birds of Prey",
          url: "https://www.mountainproject.com/route/105844620/birds-of-prey",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Rock On",
          url: "https://www.mountainproject.com/route/105910904/rock-on",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Crescent Crack (closed)",
          url: "https://www.mountainproject.com/route/107224616/crescent-crack-closed",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Jabberwocky",
          url: "https://www.mountainproject.com/route/106170451/jabberwocky",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
  ...
  "yosemite-usa": [
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Freerider",
          url: "https://www.mountainproject.com/route/106261545/freerider",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Cosmic Debris",
          url: "https://www.mountainproject.com/route/106416910/cosmic-debris",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Book of Hate",
          url: "https://www.mountainproject.com/route/114315261/book-of-hate",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Drive By Shooting",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Outer Limits",
          url: "https://www.mountainproject.com/route/105874465/outer-limits",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Catchy",
          url: "https://www.mountainproject.com/route/105939236/catchy",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "reed-pinnacle-direct-yosemite",
      ...
      externalResources: [
        {
          title: "Mountain Project: Reed's Pinnacle Direct Route",
          url: "https://www.mountainproject.com/route/105865301/reeds-pinnacle-direct-route",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "central-pillar-frenzy-yosemite",
      ...
      externalResources: [
        {
          title: "Mountain Project: Central Pillar of Frenzy",
    ...
    {
      id: "higher-cathedral-spire-regular-route-yosemite",
      name: "Higher Cathedral Spire Regular Route",
      grade: "5.9",
      type: "trad" as const,
      length: "multi-pitch",
      sector: "Yosemite Valley",
      ...
      externalResources: [
        {
          title: "Mountain Project: Regular Route (Higher Cathedral Spire)",
          url: "https://www.mountainproject.com/route/105956387/regular-route-higher-cathedral-spire",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    {
      id: "lost-arrow-spire-tip-yosemite",
      name: "Lost Arrow Spire Tip",
      grade: "5.12b",
      type: "trad" as const,
      length: "multi-pitch",
      sector: "Yosemite Valley",
      ...
      externalResources: [
        {
          title: "Mountain Project: Lost Arrow Tip",
          url: "https://www.mountainproject.com/route/105912192/lost-arrow-tip",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Muir Wall",
          url: "https://www.mountainproject.com/route/105924815/muir-wall",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
    ...
    },
    {
      ...
      externalResources: [
        {
          title: "Mountain Project: Crimson Cringe",
          url: "https://www.mountainproject.com/route/106351823/crimson-cringe",
          type: "route-database" as const,
          linkStatus: "route-specific" as const,
          description: {
            en: "External resource for current route research. ClimbAtlas does not copy beta, comments, ratings, or photos.",
